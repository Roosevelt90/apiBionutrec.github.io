                        ...
                        <div class="table-container">
                            ...
                            <div class="wizard-container" style="padding-top: 1px !important">
                                ...
                                <div class="card wizard-card" data-color="orange" id="wizardProfile">
                                    <form method="POST" action="{{ route('encuesta.update',$survey->id) }}" role="form">
                                        {{ csrf_field() }}
                                        <input name="_method" type="hidden" value="PATCH">
                                        <input type="hidden" name="id" id="id" value="{{ $survey->id }}">
                                        <input type="hidden" name="str_asesores" id="str_asesores" value="{{ $usersSurvey }}">
                                        <input type="hidden" name="str_campos" id="str_campos" value="{{ $fieldsSurvey }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                                        <div class="form-group" style="    margin-top: 18% !important;">
                                                            ...
                                                            <input type="text" required title="Este campo es requerido" name="name" id="name" class="form-control" placeholder="" value="{{ $survey->name }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select value="" required title="Este campo es requerido" name="idProject" id="idProject" class="form-control ">
                                                                ...
                                                                <option {{ ( $item->id == $survey->id_project) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                                        <div class="form-group" style="    margin-top: 18% !important;">
                                                            ...
                                                            <input type="date" required value="{{ $survey->date_begin_format() }}" title="Este campo es requerido" name="date_begin" id="date_begin" class="form-control input-sm">
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                                        <div class="form-group" style="    margin-top: 18% !important;">
                                                            <label style="    top: -28px !important;" for="date_end">Fecha de finalización</label>
                                                            <input type="date" required title="Este campo es requerido" value="{{ $survey->date_end_format() }}" name="date_end" id="date_end" class="form-control input-sm">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="account">
                                                ...
                                                <div style="display: flex; width: 100%">
                                                    ...
                                                    <div style="width: 30%; border: 2px black solid">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                                            <button class="btn btn-info " onclick="addField()" type="button" style="margin-left: 45px; margin-top: 35px;">
                                                                <span class="material-icons">
                                                                    add_circle
                                                                </span>
                                                                Agregar campo
                    ...
                    <div class="panel-body">
                        <div class="table-container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <button onclick="addAsesor()">Agrergar</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
